...
primero sacamos dimenmsión y factorizamos con un nueva variable para poder hacer comparaciones con el grupo superviviente.
...
# ```{r}
# ggplot(data = titanic_train, aes(x=Pclass, fill=Supervivencia))+
#   geom_histogram(binwidth = 1)+
#   ggtitle("Relacion Supervivencia en función de PClass: clase")
# 
# ``` 
...
Como se observa en la íltima línea del programa, la proporción de supervivientes en los hombre es del 18,89% y de las mujeres un 74,2%
