...
### Imputación de valores perdidos numéricos
...
Por otro lado, el puerto de embargue contiene una cantidad reducida de campos desconocidos, le asignaremos la categoría de _Unkown_.
...
```{r}
titanic_train[titanic_train == ""] <- "Unknown"
table(titanic_train$Embarked)
```
